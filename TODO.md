...
# 本轮需要修改的内容：
1. 学业审核更名为期末考试
2. 只有每年9月、6月才会刷新加入acm社团事件，改为可选，当月未选择自动过期
3. 只有加入acm社团才会刷出参与邀请赛、省赛、区域赛等事件。
4. 随机刷出校赛或新生赛事件，可以选择参赛，难度及组队or个人赛等都是随机的
5. 2、7、8月为假期，不上课不会掉gpa
6. 比赛事件触发后，如果参加应该马上进入比赛模式（复用codeforces参赛部分的代码）
7. 将GPA机制的变更数值增大
