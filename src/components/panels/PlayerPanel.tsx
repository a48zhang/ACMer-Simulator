...
const AttributeCard = memo(({ name, short, value, isPrimary }: AttributeCardProps) => {
  return (
    <AttrCard>
      <AttrHeader>
...
const StatusCardItem = memo(({ icon, label, value, accentColor, valueColor }: StatusCardItemProps) => {
  return (
